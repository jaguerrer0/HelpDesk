	    ...
	    <div class="container-fluid">
	        ...
	        <div class="site-header-content">
	            <div class="site-header-content-in">
                    ...
                    <input type="hidden" id="user_id" value="<?php echo $_SESSION["usu_id"] ?>"><!-- ID del Usuario Global-->
					<input type="hidden" id="rol_id" value="<?php echo $_SESSION["rol_id"] ?>"><!-- Rol de usuario -->
